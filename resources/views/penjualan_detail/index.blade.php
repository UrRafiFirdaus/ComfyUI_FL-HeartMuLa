            ...
            @csrf
                    <div class="form-group row">
                        ...
                        <div class="col-lg-5">
                            <div class="input-group">
                                <input type="hidden" name="id_pembelian" id="id_pembelian" value="{{ $id_penjualan }}">
                ...
                <div class="row">
                    <div class="col-lg-8">
                        ...
                        <div class="tampil-eja"></div>
                    </div>
                    <div class="col-lg-4">
                        <form action="{{ route('transaksi.store') }}" class="form-pembelian" method="post">
                            @csrf
                            <input type="hidden" name="id_pembelian" value="{{ $id_penjualan }}">
